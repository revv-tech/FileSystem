 ...
 */
public class ModArchivo extends javax.swing.JDialog {

    /**
     * Creates new form CrearArchivo
     */
    public ModArchivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModArchivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModArchivo dialog = new ModArchivo(new javax.swing.JFrame(), true);
