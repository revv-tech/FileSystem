 ...
 */
public class CopiarDirectorio extends javax.swing.JDialog {
    ...
    public CopiarDirectorio(java.awt.Frame parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CopiarDirectorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CopiarDirectorio dialog = new CopiarDirectorio(new javax.swing.JFrame(), true);
